<div class="content-dashboard">
    ...
    <div class="columns">
        <div class="column has-text-right">
            <button wire:click="exportarPdfVacuna" class="button">Reporte de Matriculas (Vacunas/Otros)<i class="fas fa-file-pdf ml-2"></i></button>
            <button wire:click="exportarPdfNumeros" class="button">Reporte de Matriculas (Números)<i class="fas fa-file-pdf ml-2"></i></button>
