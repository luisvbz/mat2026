<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500">Genera y descarga análisis financieros y de deudas</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {{-- Deudores PDF --}}
        <div
            class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col items-start hover:shadow-md transition-all group">
            <div
            ...
            <p class="text-sm text-gray-500 mb-6 flex-1">Lista completa de alumnos con pensiones pendientes formato PDF.
        ...
        <div
            ...
            <p class="text-sm text-gray-500 mb-6 flex-1">Exporta la lista de alumnos morosos a un archivo Excel/CSV para
        ...
        <div
            ...
            <p class="text-sm text-gray-500 mb-6 flex-1">Reporte detallado de pagos organizados por grados y meses en
                formato PDF.</p>
