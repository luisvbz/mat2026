    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-800 font-medium">Cartelera de actividades y anuncios</p>
            </div>
        </div>
        <div class="flex items-center gap-3">
            <div class="relative flex-1 md:w-80">
                <input wire:model="search" type="text"
                    class="w-full bg-white border border-gray-300 rounded-xl px-4 py-2.5 pl-10 text-sm focus:ring-colegio-500 focus:border-colegio-500 transition-all font-bold text-gray-600 shadow-sm"
            ...
            <table class="w-full text-sm text-left text-gray-600">
                <thead
                    ...
                    <tr>
                        ...
                        <th class="px-2 py-2">Recursos</th>
                ...
                <tbody class="divide-y divide-gray-50">
                                ...
                                <div class="flex items-center gap-3">
                                    @if ($event->link)
                                        <a href="{{ $event->link }}" target="_blank"
                                            class="w-9 h-9 rounded-xl bg-white border border-gray-300 flex items-center justify-center text-gray-800 hover:text-colegio-600 hover:border-colegio-200 transition-all shadow-sm group"
                                    ...
                                    @if ($event->attachment)
                                        <a href="{{ asset($event->attachment) }}" target="_blank"
                                            class="w-9 h-9 rounded-xl bg-white border border-gray-300 flex items-center justify-center text-gray-800 hover:text-green-600 hover:border-green-200 transition-all shadow-sm group"
                            ...
                            <td class="px-2 py-2 text-center">
                                <div class="flex justify-center gap-1">
                                    <a href="{{ route('dashboard.eventos.editar', $event->id) }}"
                                        class="p-2 text-gray-800 hover:text-blue-600 hover:bg-blue-50 rounded-xl transition-all"
                                        title="Editar">
                                    ...
                                    <button wire:click="delete({{ $event->id }})"
                                        ...
                                        class="p-2 text-gray-800 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all"
                                        title="Eliminar">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-2 py-16 text-center text-gray-300 italic">
