<div class="content-dashboard">
    ...
    <div class="content-dashboard-header">
        <div><i class="fas fa-plus-circle"></i> Nuevo Evento</div>
    </div>
    ...
    <div class="box-content content-dashboard-content">
        <form wire:submit.prevent="save">
                ...
                <div class="column is-12">
                    <div class="field">
                        ...
                        <div class="file has-name is-fullwidth">
                            <label class="file-label">
                                ...
                                <span class="file-name">
                                    {{ $attachment ? $attachment->getClientOriginalName() : 'Ningun archivo seleccionado' }}
                                </span>
                            </label>
                        </div>
                        ...
                        @error('attachment')
                            <p class="help is-danger">{{ $message }}</p>
                        @enderror
                        <p class="help has-text-grey">Máx 10MB. PDF, Imágenes, Documentos.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6 pt-5 border-top d-flex justify-content-end" style="border-top: 1px solid #eee;">
                ...
                <button type="submit" class="button is-primary px-5">
