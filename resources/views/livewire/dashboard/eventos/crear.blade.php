    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-800 font-medium">Publicar una nueva actividad en la cartelera</p>
            </div>
        </div>
            ...
            <form wire:submit.prevent="save" class="space-y-8">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-1.5 md:col-span-2">
                            ...
                            <p class="text-[10px] text-gray-800 italic mt-1 ml-1 font-medium italic">Máximo 10MB.</p>
                            @error('attachment')
                                <p class="text-xs text-red-600 font-medium mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="pt-6 border-t border-gray-300 flex justify-end gap-3">
                    <button type="button" wire:click="cancel"
                        class="px-8 py-3 bg-white border border-gray-200 rounded-xl text-[10px] font-bold uppercase tracking-widest text-gray-800 hover:bg-gray-50 transition-all shadow-sm">
                        Cancelar
                    </button>
