<div class="content-dashboard">
    <div class="content-dashboard-header">
        <div><i class="fas fa-plus"></i> Nuevo Profesor</div>
        ...
        <form wire:submit.prevent="save">
            <div class="columns is-multiline">
                ...
                <div class="column is-6">
                    <div class="field">
                        ...
                        <p class="help">Este será el nombre de usuario y contraseña predeterminada.</p>
                        @error('documento')
                            <p class="help is-danger">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="field has-text-right">
                <button type="submit" class="button is-primary" wire:loading.attr="disabled">
                    <span wire:loading.remove>Guardar Profesor</span>
