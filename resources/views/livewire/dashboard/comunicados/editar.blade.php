<div class="content-dashboard">
    ...
    <div class="content-dashboard-header">
        <div><i class="fas fa-bullhorn"></i> Editar Comunicado</div>
    </div>
    ...
    <div class="box-content content-dashboard-content">
        ...
        <div class="field">
            ...
            @if (!empty($existingAttachments))
                <div class="mb-3">
                    <p class="has-text-weight-semibold mb-2">Archivos actuales:</p>
                    @foreach ($existingAttachments as $attachment)
                        <div class="tags has-addons mb-2">
                            <span class="tag is-info">
                                <i class="fas fa-file mr-2"></i> {{ $attachment['name'] }}
                            </span>
                            <a class="tag is-delete"
                                wire:click="markAttachmentForDeletion({{ $attachment['id'] }})"></a>
                        </div>
                    @endforeach
                </div>
            @endif
