<div class="menu-principal" x-data="menuPrincipal()">
    ...
    <div class="menu-principal-items">
        <ul>
            ...
            <li @click='goUrl("{{ route('dashboard.profesores') }}")' class="item-menu @if($route == 'dashboard.profesores') item-active @endif"><i class="fas fa-graduation-cap"></i> Profesores</li>
            ...
            <li @click='goUrl("{{ route('asistencias.index') }}")' class="item-menu @if($route == 'asistencias.index') item-active @endif"><i class="fas fa-user-check"></i> Asistencias</li>
            <li @click='goUrl("{{ route('asistencias.inasistentes') }}")' class="item-menu @if($route == 'asistencias.inasistentes') item-active @endif"><i class="fas fa-calendar-day"></i> Inasistencias HOY</li>
            <li @click='goUrl("{{ route('dashboard.solicitudes') }}")' class="item-menu @if($route == 'dashboard.solicitudes') item-active @endif"><i class="fas fa-clipboard-check"></i> Solicitudes de Documentos</li>
