...
@foreach($matriculas as $grado)
    <div class="tabla-datos">
        ...
        <table class="tg">
            <thead>
            <tr>
                <th class="tg-pykm" colspan="8">Matrículas de {{ $grado->grado | gradoNumero }} de  {{ $grado->nivel }}</th>
            </tr>
            </thead>
            <tbody>
            <tr>
                ...
                <td class="tg-fm1b" style="text-align: center;">N.MAT</td>
                <td class="tg-fm1b" style="text-align: left;">ALUMNO</td>
                <td class="tg-fm1b" style="text-align: center;">DNI</td>
                <td class="tg-fm1b" style="text-align: center;">Fec. Nac.</td>
                <td class="tg-fm1b" style="text-align: center;">Edad</td>
                <td class="tg-fm1b" style="text-align: center;">Genero</td>
                <td class="tg-fm1b" style="text-align: center;">Celular</td>
            </tr>
            @php
                $aux = 1;
            ...
            @forelse ($grado->alumnos as $alumno)
                <tr>
                    ...
                    <td class="tg-wp8o">{{ $alumno->numero_matricula }}</td>
                    ...
                    <td class="tg-wp8o" style="text-align: center;">{{ $alumno->dni }}</td>
                    <td class="tg-wp8o" style="text-align: center;">{{ $alumno->fecha_nacimiento | date:'d/m/Y' }}</td>
                    <td class="tg-wp8o" style="text-align: center;">{{ $alumno->edad }}</td>
                    <td class="tg-wp8o" style="text-align: center;">{{ $alumno->genero }}</td>
                    <td class="tg-wp8o" style="text-align: center;">{{ $alumno->telefono }}</td>
                </tr>
                @php $aux++; @endphp
            @empty
                <tr>
