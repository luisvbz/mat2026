<html>
<title>Informe de Asistencia Mensual - Todos los Grados</title>
...
<body>
    @foreach ($datosReporte['grados'] as $index => $gradoData)
        <div class="{{ $index == 0 ? 'primera-pagina' : 'salto-pagina' }}">
            <!-- Header institucional solo en la primera página -->
            ...
            <table class="tabla-info">
                <tr>
                    ...
                    <td class="value">{{ ucfirst($datosReporte['nivel'] == 'P' ? 'Primaria' : 'Secundaria') }}</td>
                </tr>
                <tr>
                    <td class="label">Mes</td>
                    <td class="value">{{ $datosReporte['mes'] }}</td>
                    <td class="label">Grado</td>
                    <td class="value">{{ strtoupper($gradoData['gradoInfo']->nombre) }}</td>
                </tr>
            </table>
            <hr />
            ...
            <!-- Título del grado específico -->
            {{-- <div class="titulo-grado">
                {{ strtoupper($gradoData['gradoInfo']->nombre ?? 'GRADO ' . $gradoData['gradoInfo']->numero) }}
            </div> --}}
            ...
            <div class="leyenda">
                <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                    <div style="flex: 1;">
                        ...
                        <span class="leyenda-item"><strong>F</strong> Faltó</span>
